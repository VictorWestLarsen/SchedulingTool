...
namespace SchedulingTool.Migrations
{
    ...
    [Migration("20210202163638_Intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchedulingTool.Models.Todo", b =>
                {
                    b.HasOne("SchedulingTool.Models.Shift", "AddToShift")
                        .WithMany("Todos")
                        .HasForeignKey("AddToShiftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AddToShift");
                });
